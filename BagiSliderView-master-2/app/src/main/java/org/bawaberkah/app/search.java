...
public class search extends AppCompatActivity implements ProductsAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnKategori.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Context wrapper = new ContextThemeWrapper(search.this, R.style.popupMenuStyle);
    ...
    private void loadStart() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://bawaberkah.online/api/load_start.php",
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Product _list = new Product(id, judul, target, forDisplay, path, z, sinopsis
                                        ,detail, start, end);
                                search.this.productList.add(_list);
                            ...
                            adapter.setOnItemClickListener(search.this);
